...
export default function App() {
  const list = [
    {
      title: "7-Day Mediterranean Diet Meal Plan for Heart Health, Created by a Dietitian",
    ...
    {
      title: "The Best 7-Day Healthy Delicious nutrient-rich Meal Plan, Created by a Dietitian",
    ...
    {
      title: "30-Day No-Sugar, Low-Cholesterol Meal Plan for Beginners, Created by a Dietitian",
    ...
    {
      title: "7-Day No-Sugar High-Protein Delicious Healthy Meal Plan for Diabetes",
    ...
    {
      title: "7-Day No-Sugar High-Fiber Delicious Meal Plan Created by a Dietitian",
    ...
    {
      title: "7-Day No-Sugar Anti-Inflammatory Meal Plan for Metabolic Syndrome, Created by a Dietitian",
    ...
    {
      title: "7-Day No-Sugar, Anti-Inflammatory Meal Plan for Weight Loss, Created by a Dietitian",
    ...
    {
      title: "7-Day Gut-Healthy Anti-Inflammatory Meal Plan, Created by a Dietitian",
